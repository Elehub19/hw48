...
public class StorageService {
    ...
    private void fillTestData() {
        ...
        Article article1 = new Article(UUID.randomUUID(), "Польза яблок", "Яблоки полезны и содержат витамины.");
        Article article2 = new Article(UUID.randomUUID(), "Польза молока", "Молоко содержит кальций.");
